  ...
  return ( 
    <div className="max-w-4xl mx-auto p-6"> 
      ...
      <div className="mb-6"> 
        <Link 
          to="/dashboard" 
          className={`${theme === 'dark' ? 'text-blue-300': 'text-blue-600'} hover:underline flex items-center gap-2`} 
        > 
          Volver al Dashboard 
        </Link> 
      </div> 
      ...
      <div className={`card ${theme==='dark' ? 'bg-gray-700' : 'bg-white'}`}> 
        ...
        <div className="border-t pt-6 mt-6"> 
          <h2 className={`text-lg font-semibold ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} mb-4`}>Información adicional</h2> 
